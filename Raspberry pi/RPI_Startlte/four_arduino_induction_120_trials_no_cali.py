...
samplesize=400
TrialNo=240
dura=10           #duration before trial begin in secs
...
# Prepare
outfilename=time.strftime("%Y%m%d%H%M%S_induction") + ".txt"
outfilename2=time.strftime("%Y%m%d%H%M%S_induction") + "_trial.txt"
...
ser[0].write(str.encode("S"))
ser[1].write(str.encode("S"))
ser[2].write(str.encode("S"))
ser[3].write(str.encode("S"))
