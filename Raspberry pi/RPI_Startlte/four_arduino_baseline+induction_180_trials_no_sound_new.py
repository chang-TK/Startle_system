...
# Prepare
outfilename=time.strftime("%Y%m%d%H%M%S_baseline+induction") + ".txt"
outfilename2=time.strftime("%Y%m%d%H%M%S_baseline+induction") + "_trial.txt"
...
for trial in range(TrialNo2):
    ...
    # Write data to data file
    for i in range(samplesize):
        outfile.write("%3d, %s, %s, %s, %s, %3d, %lf, %s\n"%(trial+1,ID,session2,weight,group,i+1,data[i],challenge)) 
        outfile.write("%3d, %s, %s, %s, %s, %3d, %lf, %s\n"%(trial+1,ID2,session2,weight2,group2,i+1,data2[i],challenge2))  
        outfile.write("%3d, %s, %s, %s, %s, %3d, %lf, %s\n"%(trial+1,ID3,session2,weight3,group3,i+1,data3[i],challenge3))  
        outfile.write("%3d, %s, %s, %s, %s, %3d, %lf, %s\n"%(trial+1,ID4,session2,weight4,group4,i+1,data4[i],challenge4))  
    # Calculate Trial Summary
    Peak=max(data)
    Peak2=max(data2)
    Peak3=max(data3)
    ...
    outfile2.write("%3d, %s, %s, %s, %s, %lf, %lf, %4d, %lf, %lf, %lf, %lf, %s\n" 
     % (trial+1, ID, session2, weight, group, Peak, data_auc, PeakTime, Mean, Mean200, Min, Peak-Min, challenge)) 
    outfile2.write("%3d, %s, %s, %s, %s, %lf, %lf, %4d, %lf, %lf, %lf, %lf, %s\n" 
     % (trial+1, ID2, session2 ,weight2, group2, Peak2, data_auc2, PeakTime2, Mean2, Mean200_2, Min2, Peak2-Min2, challenge2)) 
    outfile2.write("%3d, %s, %s, %s, %s, %lf, %lf, %4d, %lf, %lf, %lf, %lf, %s\n" 
     % (trial+1, ID3, session2 ,weight3, group3, Peak3, data_auc3,PeakTime3, Mean3, Mean200_3, Min3, Peak3-Min3, challenge3)) 
    outfile2.write("%3d, %s, %s, %s, %s, %lf, %lf, %4d, %lf, %lf, %lf, %lf, %s\n" 
     % (trial+1, ID4, session2 ,weight4, group4, Peak4, data_auc4,PeakTime4, Mean4, Mean200_4, Min4, Peak4-Min4, challenge4))
    # Wait for ITI: inter-trial interval
    data= numpy.zeros(samplesize)
    data2= numpy.zeros(samplesize)
    data3= numpy.zeros(samplesize)
